...
export class HubScreen extends ToolScreen {
 ...
 <aside class="sidebar"><div class="brand"><span>✦</span><div>UNDER THE CANOPY<small>Asset Studio</small></div></div><a class="nav" href="/asset-editor.html">◈ &nbsp; Asset editor</a><button class="nav active" data-library>▦ &nbsp; Library</button><button class="nav" data-create>＋ &nbsp; Create asset</button><button class="nav" data-jobs>◷ &nbsp; Generation jobs</button><div class="sidebar-bottom"><small>LOCAL WORKSPACE</small><button class="nav" data-settings>⚙ &nbsp; Provider settings <i class="key-dot"></i></button></div></aside>
