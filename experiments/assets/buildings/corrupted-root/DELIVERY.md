...
- **Live preview:** [Local studio](http://127.0.0.1:8813/).
...
- **Game integration:** Integrated as a targetable finite neutral deposit with five-worker capacity and ten Root per trip; carried bundle is rendered on Workers.
...
Studio availability audit 2026-09-10: replacement viewer http://127.0.0.1:8813/ serves the correct asset and GLB. Source/model unchanged.
