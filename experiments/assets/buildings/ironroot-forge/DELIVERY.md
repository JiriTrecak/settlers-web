...
- **Live preview:** [Local studio](http://127.0.0.1:8812/).
...
- **Game integration:** Integrated with colony-wide paid research queues, permanent effects, prerequisite checks and cancellation refunds.
...
Studio availability audit 2026-09-10: replacement viewer http://127.0.0.1:8812/ serves the correct asset and GLB. Source/model unchanged.
