/** Flatten: lumberjack on a slope waits for diggers; level grass still constructs as today. */
import { describe, expect, it } from "vitest";
import { lumberjack as hutDef } from "../../src/sim/data/buildings/lumberjack";
import { averageHeight, flattenReady, footprint } from "../../src/sim/building/flatten";
...
function slope(grid: MapGrid, at: { x: number; y: number }): void {
  for (const r of hutDef.protected) {
