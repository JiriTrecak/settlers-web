...
it('keeps home construction ground dry, with a complete scenery palette and clustered timber',()=>{
 ...
 for(const id of ['ant-rock','ant-reeds','ant-lily','canopy-forest-leaves','synty-plant-flowerpatch-01','ant-driftwood'])expect(map.stamps.some(s=>s.asset===id)).toBe(true);
});
