...
async function load(){const b=readFileSync('assets/ant-colony/characters/bombardier.glb');return new GLTFLoader().parseAsync(b.buffer.slice(b.byteOffset,b.byteOffset+b.byteLength),'');}
