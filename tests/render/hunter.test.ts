...
async function load(){const b=readFileSync('assets/library/asset.models.units.ants.hunter/geometry.glb');return new GLTFLoader().parseAsync(b.buffer.slice(b.byteOffset,b.byteOffset+b.byteLength),'');}
