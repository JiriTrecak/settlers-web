...
const folder='art/sources/environment/coniferous-pack/';
const published=JSON.parse(readFileSync('assets/manifest.json'));
const manifest=JSON.parse(readFileSync(folder+'exports.json')).map(e=>({...e,file:published.records.find(r=>r.scenery.some(s=>s.id===e.id)).outputs[0].path}));
