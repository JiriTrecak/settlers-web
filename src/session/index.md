...
Session constructs `Minimap` + `MapInput` and pushes HUD stats through hooks. Lobby HUD (`Hud`, map picker) lives in `app`. Netcode: [`docs/build-plan/net.md`](../../docs/build-plan/net.md) — Session owns World, talks to Lockstep, never a socket.
