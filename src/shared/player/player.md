...
One palette in player.ts supplies gameplay, editor entity rendering, player spawn markers, territory posts, minimap markers, and placement ghosts. Slots are zero-based internally: player 1 is red.
