...
Worldroot Hollow is the only shipped battlefield (256 × 256). Its saved document is `assets/maps/skirmish/worldroot-hollow.utcmap`; the reproducible scenery pass is `scripts/maps/enrich-worldroot.py`. Two guarded Root sites, ten camps, clustered woodland, four ponds and branching streams surround two home clearings.
