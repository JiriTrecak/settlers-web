...
Finished huts with `def.occupies` (tower) stamp a radius-40 disk once — HQ at match start and each T1 you construct. Destroy unstamps that disk (overlap with another tower stays).
